...
CREATE TABLE `cidade` (
  ...
  `uf_cidade` varchar(255) DEFAULT NULL,
  `situacao_cidade` varchar(45) DEFAULT NULL,
...
CREATE TABLE `cliente` (
  ...
  `situacao_cliente` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2022-06-06 10:44:16
